...
public class TimeUtils
{
  ...
  private static int formatDurationLocked(long paramLong, int paramInt)
  {
    ...
    {
      i7 = 1;
      int i8 = printField(arrayOfChar, n, (char)'d', i6, false, 0);
      if (i8 == i6)
        break label519;
      bool1 = true;
      if (i7 == 0)
        break label525;
      i9 = 2;
      int i10 = printField(arrayOfChar, i2, (char)'h', i8, bool1, i9);
      if (i10 == i6)
        break label531;
      bool2 = true;
      if (i7 == 0)
        break label537;
      i11 = 2;
      int i12 = printField(arrayOfChar, i4, (char)'m', i10, bool2, i11);
      if (i12 == i6)
        break label543;
      bool3 = true;
      if (i7 == 0)
        break label549;
      i13 = 2;
      i14 = printField(arrayOfChar, k, (char)'s', i12, bool3, i13);
      if ((i7 == 0) || (i14 == i6))
        break label555;
    }
    label519: label525: label531: label537: label543: label549: label555: for (int i15 = 3; ; i15 = 0)
    {
      int i16 = printField(arrayOfChar, j, (char)'m', i14, true, i15);
      arrayOfChar[i16] = 's';
      return i16 + 1;
      i7 = 0;
      break;
