...
class SetTimeActivity$GroupUtil$GroupItemLongClickListener
  implements View.OnLongClickListener
{
  int pos;

  SetTimeActivity$GroupUtil$GroupItemLongClickListener(SetTimeActivity.GroupUtil paramGroupUtil, int paramInt)
  {
    this.pos = paramInt;
  }
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    final Dialog localDialog = new Dialog(SetTimeActivity.GroupUtil.access$4(this.this$1), R.style.EditLightDialog);
    ...
    localDialog.findViewById(R.id.tv_ok).setOnClickListener(new View.OnClickListener()
    {
      public void onClick(View paramAnonymousView)
      {
        ...
        Toast.makeText(SetTimeActivity.GroupUtil.access$4(SetTimeActivity.GroupUtil.GroupItemLongClickListener.this.this$1), R.string.tips_light_group_name_empty, 1).show();
      }
    });
    return true;
  }
...
/* Location:
 * Qualified Name:     com.irainxun.wifilight.SetTimeActivity.GroupUtil.GroupItemLongClickListener
