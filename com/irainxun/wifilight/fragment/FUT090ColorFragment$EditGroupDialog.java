...
public class FUT090ColorFragment$EditGroupDialog extends Dialog
{
  ...
  private View.OnClickListener clickListener = new View.OnClickListener()
  {
    public void onClick(View paramAnonymousView)
    {
      ...
      if (!MyApp.ch_zone)
        FUT090ColorFragment.access$27(FUT090ColorFragment.EditGroupDialog.this.this$0).setText(localdiydevice.zonech);
      while (true)
      {
        MyApp.deviceService.diydevice_edit(localdiydevice);
        break;
        FUT090ColorFragment.access$27(FUT090ColorFragment.EditGroupDialog.this.this$0).setText(localdiydevice.deviceid);
      }
    }
  };
  ...
  public FUT090ColorFragment$EditGroupDialog(FUT090ColorFragment paramFUT090ColorFragment, Context paramContext)
  {
    super(paramContext, R.style.EditLightDialog);
  }

  private FUT090ColorFragment$EditGroupDialog(FUT090ColorFragment paramFUT090ColorFragment, Context paramContext, int paramInt)
  {
...
/* Location:
 * Qualified Name:     com.irainxun.wifilight.fragment.FUT090ColorFragment.EditGroupDialog
