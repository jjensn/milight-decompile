...
class FUT092ColorFragment$ColorPicker$3
  implements View.OnClickListener
{
  FUT092ColorFragment$ColorPicker$3(FUT092ColorFragment.ColorPicker paramColorPicker, ImageView paramImageView, PopupWindow paramPopupWindow)
  {
  }
  ...
  public void onClick(View paramView)
  {
    ...
    if (MyApp.deviceService.wifiLight_isDeviceExists(str))
    {
      ...
      if (this.val$view != FUT092ColorFragment.ColorPicker.access$0(this.this$1))
        break label135;
    ...
    while (true)
    {
      ...
      return;
      label135: if (this.val$view == FUT092ColorFragment.ColorPicker.access$1(this.this$1))
      {
      ...
      else if (this.val$view == FUT092ColorFragment.ColorPicker.access$2(this.this$1))
      {
      ...
      else if (this.val$view == FUT092ColorFragment.ColorPicker.access$3(this.this$1))
      {
      ...
      else if (this.val$view == FUT092ColorFragment.ColorPicker.access$4(this.this$1))
      {
...
/* Location:
 * Qualified Name:     com.irainxun.wifilight.fragment.FUT092ColorFragment.ColorPicker.3
