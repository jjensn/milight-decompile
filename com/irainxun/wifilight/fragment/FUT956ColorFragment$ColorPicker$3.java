...
class FUT956ColorFragment$ColorPicker$3
  implements View.OnClickListener
{
  FUT956ColorFragment$ColorPicker$3(FUT956ColorFragment.ColorPicker paramColorPicker, ImageView paramImageView, PopupWindow paramPopupWindow)
  {
  }
  ...
  public void onClick(View paramView)
  {
    ...
    if (MyApp.deviceService.wifiLight_isDeviceExists(str))
    {
      ...
      if (this.val$view != FUT956ColorFragment.ColorPicker.access$0(this.this$1))
        break label128;
    ...
    while (true)
    {
      ...
      return;
      label128: if (this.val$view == FUT956ColorFragment.ColorPicker.access$1(this.this$1))
      {
        localwifi_light.device2 = "0";
        localwifi_light.wifilight_ang2 = "0";
        localwifi_light.wifilight_b2 = "0";
      }
      else if (this.val$view == FUT956ColorFragment.ColorPicker.access$2(this.this$1))
      {
        localwifi_light.device3 = "0";
        this.this$1.showDelPop(FUT956ColorFragment.ColorPicker.access$2(this.this$1));
        localwifi_light.wifilight_ang3 = "0";
        localwifi_light.wifilight_b3 = "0";
      }
      else if (this.val$view == FUT956ColorFragment.ColorPicker.access$3(this.this$1))
      {
        localwifi_light.device4 = "0";
        localwifi_light.wifilight_ang4 = "0";
        localwifi_light.wifilight_b4 = "0";
      }
      else if (this.val$view == FUT956ColorFragment.ColorPicker.access$4(this.this$1))
      {
...
/* Location:
 * Qualified Name:     com.irainxun.wifilight.fragment.FUT956ColorFragment.ColorPicker.3
