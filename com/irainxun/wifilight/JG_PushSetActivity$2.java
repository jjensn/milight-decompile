...
class JG_PushSetActivity$2
  implements TagAliasCallback
{
  JG_PushSetActivity$2(JG_PushSetActivity paramJG_PushSetActivity)
  {
  }
  ...
  public void gotResult(int paramInt, String paramString, Set<String> paramSet)
  {
    ...
    while (true)
    {
      ...
      if (JG_ExampleUtil.isConnected(this.this$0.getApplicationContext()))
        JG_PushSetActivity.access$0(this.this$0).sendMessageDelayed(JG_PushSetActivity.access$0(this.this$0).obtainMessage(1002, paramSet), 60000L);
      else
...
/* Location:
 * Qualified Name:     com.irainxun.wifilight.JG_PushSetActivity.2
