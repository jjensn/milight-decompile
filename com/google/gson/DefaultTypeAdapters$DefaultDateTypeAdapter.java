...
final class DefaultTypeAdapters$DefaultDateTypeAdapter
  implements JsonSerializer<java.util.Date>, JsonDeserializer<java.util.Date>
{
  ...
  DefaultTypeAdapters$DefaultDateTypeAdapter(DateFormat paramDateFormat1, DateFormat paramDateFormat2)
  {
  ...
  public String toString()
  {
    ...
    localStringBuilder.append((char)'(').append(this.localFormat.getClass().getSimpleName()).append((char)')');
    return localStringBuilder.toString();
  }
}

/* Location:
 * Qualified Name:     com.google.gson.DefaultTypeAdapters.DefaultDateTypeAdapter
